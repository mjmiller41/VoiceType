      ...
      <div className="w-full max-w-2xl bg-zinc-900/50 border border-zinc-800/80 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl flex flex-col h-[85vh]">
        ...
        <div className="bg-blue-500/10 border-b border-blue-500/20 px-4 py-2 flex items-center gap-2">
          ...
          <div className="text-xs text-blue-200/80 leading-snug">
            Keep this window open and use <strong>Auto-copy</strong> to paste anywhere. Shortcuts: Hold <strong>Space</strong> or use <strong>Ctrl+M</strong> (Cmd+M). Open in new tab if mic fails.
          </div>
        </div>
